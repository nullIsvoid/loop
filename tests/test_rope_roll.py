...
def test_single_block_half_shift_schedule():
    sched = SingleBlockHalfShiftSchedule(target_block=2)
    assert list_layer_time_shifts(5, 21, sched) == [0, 0, 10, 0, 0]
    assert sched.time_shift(2, 20) == 10
